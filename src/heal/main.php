...
/* Made by Metrix  - All Rights Reserved
* This Plugin May Be Used By Anyone,
except FreakingDev, LifeBoat, Hypixel, Or MinePlex


class main extends PluginBase{
     public function onEnable(){
          $this->getLogger()->info(c::GREEN. "Heal by Metrix enabled!");
     }
     ...
     public function onDisable(){
          $this->getLogger()->info(c::RED. "Heal by Metrix disabled!");
     }
}
